        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <div className="relative">
            <div className="relative">
              ...
              />
              {unreadCount > 0 && (
                <span className="absolute top-2 right-2 w-2.5 h-2.5 rounded-full bg-[var(--accent)] ring-2 ring-white pointer-events-none"></span>
              )}
            </div>
          ...
          <Button
            ...
            size="sm"
            icon={<Sparkles className="text-[var(--accent-300)]" />}
            className={`hidden sm:inline-flex ${!isAiAssistantOpen ? 'bg-[var(--ink)] text-white hover:bg-[var(--ink)]/90' : ''}`}
          >
            Ask AI
          </Button>
